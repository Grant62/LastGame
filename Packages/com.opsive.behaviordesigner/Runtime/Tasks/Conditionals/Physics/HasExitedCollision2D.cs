...
{
    [Description("Returns success when a 2D collision ends. This task will only receive the physics callback if it is being reevaluated (with a conditional abort or under a parallel task).")]
    [Category("Physics")]
    public class HasExitedCollision2D : Conditional
    {
        ...
        protected override bool ReceiveCollisionExit2DCallback { get => true; }
