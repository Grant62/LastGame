...
{
    [Description(
        "Returns success when an object exits the 2D trigger. This task will only receive the physics callback if it is being reevaluated (with a conditional abort or under a parallel task).")]
    [Category("Physics")]
    public class HasExitedTrigger2D : Conditional
    {
        ...
        protected override bool ReceiveTriggerExit2DCallback { get => true; }
