...
namespace Opsive.BehaviorDesigner.Runtime.Tasks
{
    ...
    public interface ITaskComponentData
    {
        ...
        /// </summary>
        [Obsolete("ITaskComponentData.Tag is deprecated. It has been replaced with IAuthoringTask.Flag.")]
    ...
    public interface IReevaluateResponder
    {
        ...
        /// </summary>
        public Type ReevaluateSystemType { get; }
    }
    ...
    public interface IInterruptResponder
    {
        ...
        /// </summary>
        public Type InterruptSystemType { get; }
    }
