...
namespace Opsive.BehaviorDesigner.Runtime.Tasks
{
    ...
    public abstract class Task : ISavableTask
    {
        ...
        internal virtual void Initialize(BehaviorTree behaviorTree, ushort runtimeIndex)
        {
            ...
            if (ReceiveCollisionEnterCallback)
            {
                m_BehaviorTree.OnBehaviorTreeCollisionEnter += OnCollisionEnter;
            }

            if (ReceiveCollisionExitCallback)
            {
                m_BehaviorTree.OnBehaviorTreeCollisionExit += OnCollisionExit;
            }

            if (ReceiveCollisionEnter2DCallback)
            {
                m_BehaviorTree.OnBehaviorTreeCollisionEnter2D += OnCollisionEnter2D;
            }

            if (ReceiveCollisionExit2DCallback)
            {
                m_BehaviorTree.OnBehaviorTreeCollisionExit2D += OnCollisionExit2D;
            }

            if (ReceiveTriggerEnterCallback)
            {
                m_BehaviorTree.OnBehaviorTreeTriggerEnter += OnTriggerEnter;
            }

            if (ReceiveTriggerExitCallback)
            {
                m_BehaviorTree.OnBehaviorTreeTriggerExit += OnTriggerExit;
            }

            if (ReceiveTriggerEnter2DCallback)
            {
                m_BehaviorTree.OnBehaviorTreeTriggerEnter2D += OnTriggerEnter2D;
            }

            if (ReceiveTriggerExit2DCallback)
            {
                m_BehaviorTree.OnBehaviorTreeTriggerExit2D += OnTriggerExit2D;
            }

            if (ReceiveControllerColliderHitCallback)
            {
                m_BehaviorTree.OnBehaviorTreeControllerColliderHit += OnControllerColliderHit;
            }
        ...
        ///     Callback when the behavior tree is started.
        /// </summary>
        [Obsolete("Task.OnStarted has been deprecated. Use Task.OnBehaviorTreeStarted instead.")]
        ...
        protected Coroutine StartCoroutine(IEnumerator routine) { return m_BehaviorTree.StartCoroutine(routine); }
        ...
        protected void StopCoroutine(IEnumerator routine) { m_BehaviorTree.StopCoroutine(routine); }
        protected void StopAllCoroutines() { m_BehaviorTree.StopAllTaskCoroutines(); }

        protected virtual bool ReceiveCollisionEnterCallback { get => false; }

        /// <summary>
        ///     Callback when OnCollisionEnter is triggered. This callback will only be received when ReceiveCollisionEnterCallback
        ///     is true.
        /// </summary>
        /// <param name="collision">The resulting collision.</param>
        protected virtual void OnCollisionEnter(Collision collision) { }

        protected virtual bool ReceiveCollisionExitCallback { get => false; }

        /// <summary>
        ///     Callback when OnCollisionExit is triggered. This callback will only be received when ReceiveCollisionExitCallback
        ///     is true.
        /// </summary>
        /// <param name="collision">The resulting collision.</param>
        protected virtual void OnCollisionExit(Collision collision) { }

        protected virtual bool ReceiveCollisionEnter2DCallback { get => false; }

        /// <summary>
        ///     Callback when OnCollisionEnter2D is triggered. This callback will only be received when
        ///     ReceiveCollisionEnter2DCallback is true.
        /// </summary>
        /// <param name="collision">The resulting collision.</param>
        protected virtual void OnCollisionEnter2D(Collision2D collision) { }

        protected virtual bool ReceiveCollisionExit2DCallback { get => false; }

        /// <summary>
        ///     Callback when OnCollisionExit2D is triggered. This callback will only be received when
        ///     ReceiveCollisionExit2DCallback is true.
        /// </summary>
        /// <param name="collision">The resulting collision.</param>
        protected virtual void OnCollisionExit2D(Collision2D collision) { }

        protected virtual bool ReceiveTriggerEnterCallback { get => false; }

        /// <summary>
        ///     Callback when OnTriggerEnter is triggered. This callback will only be received when ReceiveTriggerEnterCallback is
        ///     true.
        /// </summary>
        /// <param name="other">The overlapping collider.</param>
        protected virtual void OnTriggerEnter(Collider other) { }

        protected virtual bool ReceiveTriggerExitCallback { get => false; }

        /// <summary>
        ///     Callback when OnTriggerExit is triggered. This callback will only be received when ReceiveTriggerExitCallback is
        ///     true.
        /// </summary>
        /// <param name="other">The overlapping collider.</param>
        protected virtual void OnTriggerExit(Collider other) { }

        protected virtual bool ReceiveTriggerEnter2DCallback { get => false; }

        /// <summary>
        ///     Callback when OnTriggerEnter2D is triggered. This callback will only be received when ReceiveTriggerEnter2DCallback
        ///     is true.
        /// </summary>
        /// <param name="other">The overlapping collider.</param>
        protected virtual void OnTriggerEnter2D(Collider2D other) { }

        protected virtual bool ReceiveTriggerExit2DCallback { get => false; }

        /// <summary>
        ///     Callback when OnTriggerExit2D is triggered. This callback will only be received when ReceiveTriggerExit2DCallback
        ///     is true.
        /// </summary>
        /// <param name="other">The overlapping collider.</param>
        protected virtual void OnTriggerExit2D(Collider2D other) { }

        protected virtual bool ReceiveControllerColliderHitCallback { get => false; }

        /// <summary>
        ///     Callback when OnControllerColliderHit is triggered. This callback will only be received when
        ///     ReceiveControllerColliderHitCallback is true.
        /// </summary>
        ...
        /// </summary>
        /// <param name="paused">Is the behavior tree paused?</param>
        [Obsolete("Task.OnStopped has been deprecated. Use Task.OnBehaviorTreeStopped instead.")]
