...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Events
{
    ...
    [Description("Invoked when the agent enters a 2D trigger.")]
    public class OnTriggerEnter2D : EventNode
    {
        ...
        private void EnteredTrigger2D(Collider2D other)
        {
            ...
            if (m_StoredOtherColliderGameObject != null && m_StoredOtherColliderGameObject.IsShared)
            {
                m_StoredOtherColliderGameObject.Value = other.gameObject;
            }
