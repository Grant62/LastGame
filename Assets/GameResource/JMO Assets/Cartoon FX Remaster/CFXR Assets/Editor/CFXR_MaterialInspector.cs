...
namespace CartoonFX
{
                        ...
                        if (insideProperties)
                        {
                            ...
                            if (line.StartsWith(kGuiCommandPrefix))
                            {
                                ...
                                else if (command.StartsWith(kGC_HelpBox))
                                {
                                    ...
                                    string[] cmd = command.Substring(command.LastIndexOf(kGC_HelpBox) + kGC_HelpBox.Length + 1).Split(new[] { "::" }, StringSplitOptions.RemoveEmptyEntries);
                                    if (cmd.Length == 1)
                                    {
                                        message = cmd[0];
                                    ...
                                    else if (cmd.Length == 2)
                                    {
                                        try
                                        {
                                            MessageType msgType = (MessageType)Enum.Parse(typeof(MessageType), cmd[0], true);
    ...
    internal class MaterialKeywordEnumNoPrefixDrawer : MaterialPropertyDrawer
    {
        ...
        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3, string kw3, string lbl4, string kw4) : this(new[] { lbl1, lbl2, lbl3, lbl4 },
            new[] { kw1, kw2, kw3, kw4 }) { }

        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3, string kw3, string lbl4, string kw4, string lbl5, string kw5) : this(
            new[] { lbl1, lbl2, lbl3, lbl4, lbl5 }, new[] { kw1, kw2, kw3, kw4, kw5 }) { }

        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3, string kw3, string lbl4, string kw4, string lbl5, string kw5, string lbl6,
            string kw6) : this(new[] { lbl1, lbl2, lbl3, lbl4, lbl5, lbl6 }, new[] { kw1, kw2, kw3, kw4, kw5, kw6 }) { }
    ...
    internal class GC_Separator : GUICommand
    {
        ...
        {
            if (MaterialInspector.ShowNextProperty) Styles.MaterialDrawSeparator();
        }
    }
    ...
    internal class GC_SeparatorDouble : GUICommand
    {
        public override void OnGUI()
        {
            if (MaterialInspector.ShowNextProperty) Styles.MaterialDrawSeparatorDouble();
        }
    }
    ...
    internal class GC_Space : GUICommand
    {
        public override void OnGUI()
        {
            if (MaterialInspector.ShowNextProperty) GUILayout.Space(8);
        }
    }
    ...
    {
        public override void OnGUI() { MaterialInspector.PopShowProperty(); }
    }
