...
namespace CartoonFX
{
        ...
        private float CalculateShapeDensity(ParticleSystem.ShapeModule shapeModule, bool isShapeScaling, Transform transform)
        {
            ...
            switch (shapeModule.shapeType)
            {
                ...
                case ParticleSystemShapeType.Donut:
                {
                    ...
                    float innerDonutVolume = 2 * Mathf.PI * Mathf.PI * shapeModule.donutRadius * thicknessPercentage * thicknessPercentage * shapeModule.donutRadius * shapeModule.radius
                                             * arcPercentage;
    ...
    {
        private CFXR_EmissionBySurface Target { get => target as CFXR_EmissionBySurface; }
