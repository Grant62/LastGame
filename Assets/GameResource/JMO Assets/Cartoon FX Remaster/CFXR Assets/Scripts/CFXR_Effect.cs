...
namespace CartoonFX
{
    ...
    public partial class CFXR_Effect : MonoBehaviour
    {
        ...
        private static readonly int _GameObjectWorldPosition = Shader.PropertyToID("_GameObjectWorldPosition");
        ...
        [NonSerialized] private Renderer particleRenderer;
        ...
        [NonSerialized] private ParticleSystem _parentParticle;
        ...
        [NonSerialized] public bool editorUpdateRegistered;

        [NonSerialized] private bool particleWasStopped;
        [NonSerialized] private float particleTime;
#if !DISABLE_LIGHTS || !DISABLE_CAMERA_SHAKE
        [NonSerialized] private float particleTimeUnwrapped;
#endif
