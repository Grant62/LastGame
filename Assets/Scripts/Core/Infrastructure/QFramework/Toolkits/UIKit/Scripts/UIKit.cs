...
")]
        ...
        {
            PanelSearchKeys panelSearchKeys = PanelSearchKeys.Allocate();
...
")]
        ...
        public static T GetPanel<T>() where T : UIPanel
        {
            ...
            UIPanel retPanel = UIManager.Instance.GetUI(panelSearchKeys);
        ...
        public static UIPanel OpenPanel(string panelName, UILevel level = UILevel.Common, string assetBundleName = null)
        {
            ...
            IPanel retPanel = UIManager.Instance.OpenUI(panelSearchKeys);
