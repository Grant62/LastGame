...
namespace QFramework
{
    public class ResKitEditorWindow : EditorWindow
    {
        ...
        {
            get => EditorPrefs.GetBool(ResKitView.KEY_AUTOGENERATE_CLASS, false);
        }
    ...
    public class ResKitView
    {
        ...
        public void OnGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            int index = ResKitEditorAPI.SimulationMode ? 0 : 1;
            ...
            mScrollViewPosition = GUILayout.BeginScrollView(mScrollViewPosition);
            {
                GUILayout.BeginVertical("box");
                {
                    foreach (string n in AssetDatabase.GetAllAssetBundleNames()
                                 .SelectMany(n =>
                                 {
                                     string[] result = AssetDatabase.GetAssetPathsFromAssetBundle(n);
        ...
        public class LocaleText
        {
            ...
            public static string ResKit { get => IsCN ? "Res Kit 设置" : "Res Kit Setting"; }

            public static string GoToPersistent { get => IsCN ? "打开 Persistent 目录" : "Go To Persistance"; }

            public static string GenerateClass { get => IsCN ? "生成代码（资源名常量）" : "Generate Class"; }

            public static string Build { get => IsCN ? "打 AB 包" : "Build"; }

            public static string ForceClear { get => IsCN ? "清空已生成的 AB" : "ForceClear"; }

            public static string AutoGenerateClass { get => IsCN ? "打 AB 包时，自动生成资源名常量代码" : "auto generate class when build"; }
            ...
            public static string[] GenerateClassNameStyleItems { get => IsCN ? mGenerateClassNameStyleItemsCN : mGenerateClassNameStyleItemsEN; }
            ...
            public static string[] ModeMenu { get => IsCN ? mModeMenuCN : mModeMenuEN; }
