...
namespace QFramework
{
    ...
    {
        private static IResDatas mAssetBundleConfigFile;
        ...
        public static List<IResDatas> SubProjectAssetBundleConfigFiles = new();

        public static bool LoadAssetResFromStreamingAssetsPath
        {
            get => PlayerPrefs.GetInt("LoadResFromStreamingAssetsPath", 1) == 1;
        ...
        {
            get => "/AssetBundles/" + AssetBundlePathHelper.GetPlatformName() + "/";
        }
        #endregion
    }
}