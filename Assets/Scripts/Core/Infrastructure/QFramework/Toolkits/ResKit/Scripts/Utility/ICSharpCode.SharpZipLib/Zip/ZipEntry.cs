...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipEntry
    {
        ...
        {
            get => HostSystem == (int)HostSystemID.Msdos ||
        ...
        {
            get => Version <= ZipConstants.VersionMadeBy &&
                   (Version == 10 ||
                    Version == 11 ||
                    Version == 20 ||
                    Version == 45 ||
        ...
        {
            get => LocalHeaderRequiresZip64 || Offset >= uint.MaxValue;
        }
        ...
        {
            get => AESKeySize > 0 ? CompressionMethod.WinZipAES : method;
        }
        ...
        {
            get => (byte)_aesEncryptionStrength;
        }
        ...
        {
            ZipExtraData extraData = new(extra);
...
#pragma warning restore 0219
        ...
        public bool IsFile
        {
            get => !IsDirectory && !HasDosAttributes(8);
        }
