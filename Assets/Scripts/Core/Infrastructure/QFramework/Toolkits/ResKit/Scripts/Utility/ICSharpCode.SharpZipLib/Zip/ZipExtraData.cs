...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public sealed class ZipExtraData : IDisposable
    {
        ...
        public Stream GetStreamForTag(int tag)
        {
            ...
            if (Find(tag))
            {
                result = new MemoryStream(_data, CurrentReadIndex, ValueLength, false);
            }
            ...
            where T : class, ITaggedData, new()
        {
            ...
            {
                result.SetData(_data, _readValueStart, ValueLength);
                return result;
            }
        ...
        public bool Find(int headerID)
        {
            ...
            bool result = localTag == headerID && CurrentReadIndex + localLength <= _data.Length;
        ...
        public int ReadInt()
        {
            ...
            int result = _data[CurrentReadIndex] + (_data[CurrentReadIndex + 1] << 8) +
