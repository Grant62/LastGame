...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipFile : IEnumerable, IDisposable
    {
        ...
        private void OnKeysRequired(string fileName)
        {
            ...
            {
                KeysRequiredEventArgs krea = new(fileName, Key);
        ...
        {
            get => (ZipEntry)entries_[index].Clone();
        }
        #endregion
            ...
            try
            {
                ...
                while (testing && entryIndex < Count)
                {
                    ...
                    if (testing && testData && this[entryIndex].IsFile)
                    {
                        ...
                        {
                            ZipHelperStream helper = new(baseStream_);
                            DescriptorData data = new();
        ...
        private long TestLocalHeader(ZipEntry entry, HeaderTest tests)
        {
            lock (baseStream_)
            {
                ...
                ZipExtraData localExtraData = new(extraData);
        ...
        public void CommitUpdate()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        byte[] theComment = newComment_ != null ? newComment_.RawComment : ZipConstants.ConvertToArray(ZipFileComment);
        ...
        */
        ...
        private void WriteLocalEntryHeader(ZipUpdate update)
        {
            ...
            ZipExtraData ed = new(entry.ExtraData);
        ...
        private Stream GetOutputStream(ZipEntry entry)
        {
            ...
            switch (entry.CompressionMethod)
            {
                ...
                case CompressionMethod.Deflated:
                    DeflaterOutputStream dos = new(result, new Deflater(9, true));
        ...
        private void AddEntry(ZipFile workFile, ZipUpdate update)
        {
            ...
            if (source != null)
            {
                using (source)
                {
                    ...
                    {
                        ZipHelperStream helper = new(workFile.baseStream_);
        ...
        private void RunUpdates()
        {
            ...
            try
            {
                ...
                byte[] theComment = newComment_ != null ? newComment_.RawComment : ZipConstants.ConvertToArray(ZipFileComment);
                using (ZipHelperStream zhs = new(workFile.baseStream_))
                {
...
#pragma warning restore 0219
                ...
                ZipEntry entry = new(name, versionToExtract, versionMadeBy, (CompressionMethod)method);
        ...
        private Stream CreateAndInitDecryptionStream(Stream baseStream, ZipEntry entry)
        {
            ...
            else
            {
                if (entry.Version == ZipConstants.VERSION_AES)
                {
                    ...
                    ZipAESTransform decryptor = new(rawPassword_, saltBytes, blockSize, false);
