...
namespace QFramework
{
    ...
    {
        public static MD5Manager Instance { get => SingletonProperty<MD5Manager>.Instance; }
        ...
        public void SaveMd5(string filePath, string md5SavePath)
        {
            ...
            StreamWriter sw = new(name, false, Encoding.UTF8);
            if (sw != null)
            {
                sw.Write(md5);
                sw.Flush();
        ...
        public string GetMd5(string path)
        {
            ...
            try
            {
                StreamReader sr = new(name, Encoding.UTF8);
        ...
        public string BuildFileMd5(string fliePath)
        {
            ...
            try
            {
                using (FileStream fileStream = File.OpenRead(fliePath))
                {
                    MD5 md5 = MD5.Create();
