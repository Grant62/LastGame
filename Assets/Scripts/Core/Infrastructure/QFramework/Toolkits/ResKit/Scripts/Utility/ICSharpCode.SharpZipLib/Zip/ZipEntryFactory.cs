...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipEntryFactory : IEntryFactory
    {
        ...
        {
            ZipEntry result = new(nameTransform_.TransformFile(!string.IsNullOrEmpty(entryName) ? entryName : fileName));
        ...
        {
            ZipEntry result = new(nameTransform_.TransformDirectory(directoryName));
            result.IsUnicodeText = IsUnicodeText;
            result.Size = 0;
