...
namespace QFramework
{
    ...
    public class AudioManager : MonoBehaviour, ISingleton
    {
        ...
        public void OnSingletonInit()
        {
            ...
            AudioKit.Settings.SoundVolume.Register(soundVolume => { ForEachAllSound(player => player.SetVolume(soundVolume)); }).UnRegisterWhenGameObjectDestroyed(gameObject);
        }
        ...
        {
            foreach (AudioPlayer audioPlayer in mSoundPlayerInPlaying.SelectMany(keyValuePair => keyValuePair.Value))
            {
        ...
        public static void PlayVoiceOnce(string voiceName)
        {
            ...
            AudioPlayer unit = SafeObjectPool<AudioPlayer>.Instance.Allocate();
        ...
        {
            get => MonoSingletonProperty<AudioManager>.Instance;
        }
        #endregion
