...
namespace QFramework
{
    ...
    public class AudioKit
    {
        ...
        {
            get => AudioManager.Instance.MusicPlayer;
        }
...
")]
        ...
        public static AudioPlayer VoicePlayer { get => AudioManager.Instance.VoicePlayer; }
...
")]
        ...
        private static bool CanPlaySound(string soundName)
        {
            ...
            {
                if (mSoundFrameCountForName.TryGetValue(soundName, out int frames))
                {
...
")]
            ...
            int customEventId = -1, float volumeScale = 1.0f)
        {
            ...
            AudioPlayer soundPlayer = SafeObjectPool<AudioPlayer>.Instance.Allocate();
...
")]
    ...
    public class DefaultAudioLoader : IAudioLoader
    {
        ...
        {
            ResourceRequest resourceRequest = Resources.LoadAsync<AudioClip>(audioSearchKeys.AssetName);
