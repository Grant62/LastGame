...
namespace QFramework.TimeExtend
{
    public class Timer
    {
        ...
        ///     获得当前时间
        /// </summary>
        private float CurrentTime { get => _ignorTimescale ? Time.realtimeSinceStartup : Time.time; }
        ...
        ///     当前定时器设定的时间
        /// </summary>
        public float Duration { get => _time; } //
        ...
        {
            Timer timer = new(time, flag, loop, ignorTimescale);
            timers.Add(timer);
            return timer;
        }
        #endregion
