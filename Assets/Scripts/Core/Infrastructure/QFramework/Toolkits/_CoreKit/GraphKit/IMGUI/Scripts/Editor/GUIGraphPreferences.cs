    ...
    public static class GUIGraphPreferences
    {
        ...
        public class Settings : ISerializationCallbackReceiver
        {
            ...
            public void OnBeforeSerialize()
            {
                ...
                typeColorsData = "";
                foreach (KeyValuePair<string, Color> item in typeColors)
                {
        ...
        {
            SettingsProvider provider = new("Preferences/GraphKit/IMGUI Graph Editor", SettingsScope.User)
            {
...
#if !UNITY_2019_1_OR_NEWER
        [PreferenceItem("GrpahKit IMGUI Editor")]
#endif
        ...
        private static void NodeSettingsGUI(string key, Settings settings)
        {
            ...
            settings.guiGraphConnectionPath = (GUIGraphConnectionPath)EditorGUILayout.EnumPopup("Noodle path", settings.guiGraphConnectionPath);
        ...
        private static void TypeColorsGUI(string key, Settings settings)
        {
            ...
            List<Type> typeColorKeys = new(typeColors.Keys);
