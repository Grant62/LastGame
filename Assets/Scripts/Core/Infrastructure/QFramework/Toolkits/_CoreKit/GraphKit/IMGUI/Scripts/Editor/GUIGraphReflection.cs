...
namespace QFramework
{
    ...
    public static class GUIGraphReflection
    {
        ...
        {
            get => _nodeTypes != null ? _nodeTypes : _nodeTypes = GetNodeTypes();
        }
        ...
        public static Type[] GetNodeTypes()
        {
            ...
            return typeof(GUIGraphNode).GetDerivedTypes();
        }
        ...
        public static void AddCustomContextMenuItems(this GenericMenu contextMenu, object obj)
        {
            ...
            if (items.Length != 0)
            {
                ...
                List<string> invalidatedEntries = new();
        ...
        public static KeyValuePair<ContextMenu, MethodInfo>[] GetContextMenuMethods(object obj)
        {
            ...
            List<KeyValuePair<ContextMenu, MethodInfo>> kvp = new();
