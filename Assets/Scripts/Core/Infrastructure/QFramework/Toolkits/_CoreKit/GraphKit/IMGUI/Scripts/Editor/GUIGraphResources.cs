...
namespace QFramework
{
    ...
    {
        // Textures
        public static Texture2D Dot { get => mDot != null ? mDot : mDot = Resources.Load<Texture2D>("graphkit_imgui_dot"); }

        private static Texture2D mDot;

        public static Texture2D DotOuter { get => mDotOuter != null ? mDotOuter : mDotOuter = Resources.Load<Texture2D>("graphkit_imgui_dot_outer"); }

        private static Texture2D mDotOuter;

        public static Texture2D NodeBody { get => mNodeBody != null ? mNodeBody : mNodeBody = Resources.Load<Texture2D>("graphkit_imgui_node"); }

        private static Texture2D mNodeBody;

        public static Texture2D NodeHighlight
        {
            get => mNodeHighlight != null
                ? mNodeHighlight
        ...
        // Styles
        public static Styles styles { get => mStyles ?? (mStyles = new Styles()); }

        private static Styles mStyles;

        public static GUIStyle OutputPort
        {
            get => new(EditorStyles.label) { alignment = TextAnchor.UpperRight };
        }
