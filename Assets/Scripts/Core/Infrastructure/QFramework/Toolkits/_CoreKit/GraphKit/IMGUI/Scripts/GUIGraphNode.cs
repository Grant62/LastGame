...
namespace QFramework
{
    ...
    public abstract class GUIGraphNode : ScriptableObject
    {
        ...
        ///     field value associated with a <see cref="NodePort" />
        /// </summary>
        ...
        /// </summary>
        [SerializeField] private NodePortDictionary ports = new();
            ...
            TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null)
        {
            ...
            GUIGraphNodePort port = new(fieldName, type, direction, connectionType, typeConstraint, this);
        ...
        {
            List<GUIGraphNodePort> dynamicPorts = new(DynamicPorts);
        ...
        private class NodePortDictionary : Dictionary<string, GUIGraphNodePort>, ISerializationCallbackReceiver
        {
            ...
            [SerializeField] private List<GUIGraphNodePort> values = new();
