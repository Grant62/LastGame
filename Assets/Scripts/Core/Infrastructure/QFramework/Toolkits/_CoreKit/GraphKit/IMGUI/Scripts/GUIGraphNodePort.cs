...
namespace QFramework
{
    ...
    public class GUIGraphNodePort
    {
        ...
        public bool IsInput
        {
            get => direction == IO.Input;
        }

        public bool IsOutput
        {
            get => direction == IO.Output;
        }
        ...
        public GUIGraphNode node { get => _node; }
        ...
        {
            List<GUIGraphNodePort> result = new();
            for (int i = 0; i < connections.Count; i++)
            {
        ...
        public void SwapConnections(GUIGraphNodePort targetPort)
        {
            ...
            List<GUIGraphNodePort> portConnections = new();
            List<GUIGraphNodePort> targetPortConnections = new();
        ...
        private class PortConnection
        {
            ...
            {
                get => port != null ? port : port = GetPort();
            }
