...
namespace QFramework
{
    ...
    public class GUIGraphEditor : GUIGraphEditorBase<GUIGraphEditor, GUIGraphEditor.CustomNodeGraphEditorAttribute, GUIGraph>
    {
        ...
        public virtual void AddContextMenuItems(GenericMenu menu)
        {
            ...
            Type[] nodeTypes = GUIGraphReflection.nodeTypes.OrderBy(type => GetNodeMenuOrder(type)).ToArray();
        ...
        public virtual void RemoveNode(GUIGraphNode node)
        {
            ...
            foreach (GUIGraphNodePort port in node.Ports)
            foreach (GUIGraphNodePort conn in port.GetConnections())
