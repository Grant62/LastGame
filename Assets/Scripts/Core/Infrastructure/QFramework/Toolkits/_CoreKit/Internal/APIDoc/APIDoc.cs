...
namespace QFramework
{
    ...
    internal class APIDoc : IPackageKitView, IUnRegisterList
    {
        ...
        public void Init()
        {
            ...
            mSplitView = new VerticalSplitView(240)
            {
                FirstPan = rect =>
                {
                    ...
                    foreach (ClassAPIGroupRenderInfo groupRenderInfo in mGroupRenderInfos)
                    {
                        ...
                        if (EditorGUILayout.Foldout(groupRenderInfo.Open.Value, groupRenderInfo.GroupName, true))
                        {
                            ...
                            foreach (ClassAPIRenderInfo classAPIRenderInfo in groupRenderInfo.ClassAPIRenderInfos)
                            {
                                GUILayout.BeginVertical("box");
            ...
            new StringBuilder()
                ...
                .Self(builder =>
                {
                    if (mSelectionClassAPIRenderInfo.Properties.Any())
                    {
                        ...
                        foreach (PropertyAPIRenderInfo property in mSelectionClassAPIRenderInfo.Properties)
                        {
                            builder.AppendLine()
                ...
                .Self(builder =>
                {
                    if (mSelectionClassAPIRenderInfo.Methods.Any())
                    {
                        ...
                        foreach (MethodAPIRenderInfo method in mSelectionClassAPIRenderInfo.Methods)
                        {
                            builder.AppendLine()
        ...
        public void OnShow()
        {
            ...
            {
                ClassAPIGroupRenderInfo firstGroup = mGroupRenderInfos.First();
