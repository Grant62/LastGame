...
namespace QFramework
{
    ...
    {
        public string Description { get => LocaleKitEditor.IsCN.Value ? mDescriptionCN.Description : mDescriptionEN.Description; }
        ...
        public void Parse()
        {
            ...
            APIExampleCodeAttribute exampleCode = mType.GetAttribute<APIExampleCodeAttribute>();
            if (exampleCode != null)
            {
