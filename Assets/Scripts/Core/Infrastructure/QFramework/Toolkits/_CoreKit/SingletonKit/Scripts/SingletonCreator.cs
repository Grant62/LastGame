...
namespace QFramework
{
    ...
    internal static class SingletonCreator
    {
            ...
            bool dontDestroy)
        {
            ...
            {
                Transform child = root.transform.Find(subPath[index]);
                if (child != null)
                {
        ...
        public static T CreateMonoSingleton<T>() where T : class, ISingleton
        {
            ...
            foreach (object atribute in attributes)
            {
                MonoSingletonPathAttribute defineAttri = atribute as MonoSingletonPathAttribute;
                if (defineAttri == null)
                {
                    continue;
                }
        ...
        {
            GameObject obj = FindGameObject(path, true, dontDestroy);
            if (obj == null)
            {
