...
")]
        ...
        {
            Vector3 localPosition = selfComponent.transform.localPosition;
            localPosition.x = x;
            localPosition.y = y;
...
")]
        ...
        {
            Vector3 localScale = selfComponent.transform.localScale;
            localScale.x = x;
            localScale.y = y;
            localScale.z = z;
...
")]
        ...
        {
            Vector3 position = selfComponent.transform.position;
            position.x = x;
            position.y = y;
            selfComponent.transform.position = position;
            return selfComponent;
...
")]
            ...
            where T : Component
        {
            ...
            for (int i = 0; i < childCount; i++)
            {
                Transform child = selfComponent.transform.GetChild(i);
                if (condition(child))
                {
