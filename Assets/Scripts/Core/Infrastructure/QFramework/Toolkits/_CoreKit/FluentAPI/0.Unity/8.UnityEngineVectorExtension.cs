...
")]
        ...
        {
            return self.DirectionTo(to).normalized;
        }
...
")]
        ...
        {
            return self.DirectionFrom(from).normalized;
        }
...
")]
        ...
        {
            return self.Direction2DTo(to).normalized;
        }
...
")]
        ...
        {
            return self.Direction2DFrom(from).normalized;
        }
