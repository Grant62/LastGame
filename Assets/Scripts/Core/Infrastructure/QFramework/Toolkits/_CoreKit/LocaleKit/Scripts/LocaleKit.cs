...
namespace QFramework
{
    public class LocaleKit : Architecture<LocaleKit>
    {
        ...
        public static void AutoInit()
        {
            ...
            if (Config)
            {
                IArchitecture @interface = Interface;
        ...
        {
            int languageIndex = LoadCommand("CURRENT_LANGUAGE_INDEX", 0);
        ...
        public static LanguageDefineConfig Config { get => mConfig ? mConfig : mConfig = Resources.Load<LanguageDefineConfig>(nameof(LanguageDefineConfig)); }
