...
using StackFrame = MoonSharp.VsCodeDebugger.SDK.StackFrame;

namespace MoonSharp.VsCodeDebugger.DebuggerLogic
{
    internal class MoonSharpDebugSession : DebugSession, IAsyncDebuggerClient
    {
        private readonly AsyncDebugger m_Debug;
        private readonly MoonSharpVsCodeDebugServer m_Server;
        private readonly List<DynValue> m_Variables = new();
        ...
        public override void SetBreakpoints(Response response, Table args)
        {
            ...
            HashSet<int> lin = new(clientLines.Values.Select(jt => ConvertClientLineToDebugger(jt.ToObject<int>())).ToArray());
        ...
        private readonly SourceRef DefaultSourceRef = new(-1, 0, 0, 0, 0, false);
