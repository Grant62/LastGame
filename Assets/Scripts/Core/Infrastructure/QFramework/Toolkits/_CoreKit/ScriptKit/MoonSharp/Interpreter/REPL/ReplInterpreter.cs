...
namespace MoonSharp.Interpreter.REPL
{
	...
	public class ReplInterpreter
    {
        ...
        /// </summary>
        public virtual bool HasPendingCommand { get => m_CurrentCommand.Length > 0; }

        /// <summary>
        ///     Gets the current pending command.
        /// </summary>
        public virtual string CurrentPendingCommand { get => m_CurrentCommand; }

        /// <summary>
        ///     Gets the classic prompt (">" or ">>") given the current state of the interpreter
        /// </summary>
        public virtual string ClassicPrompt { get => HasPendingCommand ? ">>" : ">"; }
