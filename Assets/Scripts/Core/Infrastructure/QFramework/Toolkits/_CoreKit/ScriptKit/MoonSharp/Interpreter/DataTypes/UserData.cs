...
namespace MoonSharp.Interpreter
{
	...
	public class UserData : RefIdObject
    {
        ...
        /// <param name="friendlyName">A friendly name for the descriptor.</param>
        /// <returns></returns>
        public static IUserDataDescriptor RegisterProxyType<TProxy, TTarget>(Func<TTarget, TProxy> wrapDelegate, InteropAccessMode accessMode = InteropAccessMode.Default,
        ...
        public static Table GetDescriptionOfRegisteredTypes(bool useHistoricalData = false)
        {
            ...
            IEnumerable<KeyValuePair<Type, IUserDataDescriptor>> registeredTypesPairs =
                useHistoricalData ? TypeDescriptorRegistry.RegisteredTypesHistory : TypeDescriptorRegistry.RegisteredTypes;
