...
namespace MoonSharp.Interpreter
{
    ...
    public class CallbackArguments
    {
        ...
        {
            get => RawGet(index, true) ?? DynValue.Void;
        }
        ...
        {
            DynValue v = AsType(argNum, funcName, DataType.Number);
            double d = v.Number;
            return (int)d;
        }
        ...
        public string AsStringUsingMeta(ScriptExecutionContext executionContext, int argNum, string funcName)
        {
            ...
            {
                DynValue v = executionContext.GetScript().Call(this[argNum].Table.MetaTable.RawGet("__tostring"), this[argNum]);
