...
namespace MoonSharp.Interpreter.Interop
{
	...
	public class OverloadedMethodMemberDescriptor : IOptimizableDescriptor, IMemberDescriptor, IWireableDescriptor
    {
            ...
            for (int i = 0; i < method.Parameters.Length; i++)
            {
                ...
                if (i == method.Parameters.Length - 1 && method.VarArgsArrayType != null)
                {
                    ...
                    while (true)
                    {
                        ...
                        int score = CalcScoreForSingleArgument(method.Parameters[i], method.VarArgsElementType, arg, false);
        ...
        {
            get => MemberDescriptorAccess.CanExecute | MemberDescriptorAccess.CanRead;
        }
        ...
        public void PrepareForWiring(Table t)
        {
            ...
            foreach (IOverloadableMemberDescriptor m in m_Overloads)
            {
