...
namespace MoonSharp.Interpreter.CoreLib
{
    ...
    public class MathModule
    {
        ...
        {
            DynValue arg = args.AsType(0, funcName, DataType.Number);
            DynValue arg2 = args.AsType(1, funcName, DataType.Number);
        ...
        private static DynValue execaccum(CallbackArguments args, string funcName, Func<double, double, double> func)
        {
            ...
            {
                DynValue arg = args.AsType(i, funcName, DataType.Number);
        ...
        public static DynValue frexp(ScriptExecutionContext executionContext, CallbackArguments args)
        {
            ...
            DynValue arg = args.AsType(0, "frexp", DataType.Number);
        ...
        {
            DynValue arg = args.AsType(0, "randomseed", DataType.Number);
