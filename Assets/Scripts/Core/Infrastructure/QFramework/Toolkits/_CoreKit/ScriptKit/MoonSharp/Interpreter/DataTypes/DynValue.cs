...
namespace MoonSharp.Interpreter
{
	...
	public sealed class DynValue
    {
        ...
        /// </summary>
        public Closure Function { get => m_Object as Closure; }
        ...
        /// </summary>
        public DynValue[] Tuple { get => m_Object as DynValue[]; }

        /// <summary>
        ///     Gets the coroutine handle. (valid only if the <see cref="Type" /> is Thread).
        /// </summary>
        public Coroutine Coroutine { get => m_Object as Coroutine; }

        /// <summary>
        ///     Gets the table (valid only if the <see cref="Type" /> is <see cref="DataType.Table" />)
        /// </summary>
        public Table Table { get => m_Object as Table; }

        /// <summary>
        ///     Gets the boolean value (valid only if the <see cref="Type" /> is <see cref="DataType.Boolean" />)
        /// </summary>
        public bool Boolean { get => Number != 0; }

        /// <summary>
        ///     Gets the string value (valid only if the <see cref="Type" /> is <see cref="DataType.String" />)
        /// </summary>
        public string String { get => m_Object as string; }

        /// <summary>
        ///     Gets the CLR callback (valid only if the <see cref="Type" /> is <see cref="DataType.ClrFunction" />)
        /// </summary>
        public CallbackFunction Callback { get => m_Object as CallbackFunction; }

        /// <summary>
        ///     Gets the tail call data.
        /// </summary>
        public TailCallData TailCallData { get => m_Object as TailCallData; }

        /// <summary>
        ///     Gets the yield request data.
        /// </summary>
        public YieldRequest YieldRequest { get => m_Object as YieldRequest; }

        /// <summary>
        ///     Gets the tail call data.
        /// </summary>
        public UserData UserData { get => m_Object as UserData; }
