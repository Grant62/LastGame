...
namespace MoonSharp.Interpreter.Interop
{
	...
	public static class InteropRegistrationPolicy
    {
	    ...
	    /// </summary>
	    public static IRegistrationPolicy Default { get => new DefaultRegistrationPolicy(); }
        ...
        public static IRegistrationPolicy Explicit { get => new DefaultRegistrationPolicy(); }

	    /// <summary>
	    ///     Types are automatically registered if not found in the registry. This is easier to use but potentially unsafe.
	    /// </summary>
	    public static IRegistrationPolicy Automatic { get => new AutomaticRegistrationPolicy(); }
    }
}