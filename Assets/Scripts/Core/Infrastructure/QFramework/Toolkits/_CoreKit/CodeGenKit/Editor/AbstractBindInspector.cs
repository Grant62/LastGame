...
namespace QFramework
{
    ...
    public class AbstractBindInspector : Editor
    {
        ...
        private AbstractBind mBindScript { get => target as AbstractBind; }
        ...
        {
            Component[] components = mBindScript.GetComponents<Component>();
        ...
        public override void OnInspectorGUI()
        {
            ...
            GameObject rootGameObj = CodeGenHelper.GetBindBelongs2GameObject(mBindScript);
