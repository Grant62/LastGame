...
namespace QFramework
{
    internal class MDBlockContainer : MDBlock
    {
        ...
        public override MDBlock Find(string id)
        {
            ...
            foreach (MDBlock block in mBlocks)
            {
                MDBlock match = block.Find(id);
        ...
        public override void Draw(MDContext context)
        {
            ...
            {
                MDBlockContainer parentBlock = Parent as MDBlockContainer;
                if (parentBlock == null)
                {
                ...
                {
                    int idx = parentBlock.mBlocks.IndexOf(this);
