...
namespace QFramework
{
    ...
    public class ReleaseItem
    {
        ...
        public int VersionNumber
        {
            get
            {
                ...
                string[] numbersStr = version.Replace("v", string.Empty).Split('.');

                int retNumber = numbersStr[2].ParseToInt();
    ...
    public class Readme
    {
        ...
        public void AddReleaseNote(ReleaseItem pluginReadme)
        {
            ...
            {
                bool exist = false;
                foreach (ReleaseItem item in items)
                {
    ...
    public class PackageData
    {
        ...
        {
            get => PackageVersions.FirstOrDefault();
        }


        public string version
        {
            get => mLatestVersion == null ? string.Empty : mLatestVersion.Version;
        }

        public string DownloadUrl
        {
            get => mLatestVersion == null ? string.Empty : mLatestVersion.DownloadUrl;
        }

        public string InstallPath
        {
            get => mLatestVersion == null ? string.Empty : mLatestVersion.InstallPath;
        }

        public string DocUrl
        {
            get => mLatestVersion == null ? string.Empty : mLatestVersion.DocUrl;
        }

        public PackageType Type
        {
            get => mLatestVersion == null ? PackageType.AppOrGameDemoOrTemplate : mLatestVersion.Type;
        }

        public PackageAccessRight AccessRight
        {
            get => PackageVersions.FirstOrDefault() == null
        ...
        {
            get => Directory.Exists(InstallPath);
        }
    ...
    public class PackageVersion
    {
        ...
        public string Name
        {
            get
            {
                ...
                {
                    string name = InstallPath.Replace("\\", "/");
