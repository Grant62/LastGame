...
namespace QFramework
{
    public class MDHistory
    {
        ...
        public bool IsEmpty { get => mHistory.Count == 0; }

        public int Count { get => mHistory.Count; }

        public string Current { get => mIndex >= 0 ? mHistory[mIndex] : null; }

        public bool CanBack { get => mIndex > 0; }

        public bool CanForward { get => mIndex != mHistory.Count - 1; }
