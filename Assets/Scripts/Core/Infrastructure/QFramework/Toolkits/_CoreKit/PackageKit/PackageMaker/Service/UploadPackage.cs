...
namespace QFramework
{
    public static class UploadPackage
    {
        ...
        {
            get => "https://api.liangxiegame.com/qf/v4/package/add";
        }
        ...
        public static void DoUpload(PackageVersion packageVersion, Action succeed)
        {
            ...
            string fileName = packageVersion.Name + "_" + packageVersion.Version + ".unitypackage";
            string fullPath = ExportPaths(fileName, packageVersion.IncludeFileOrFolders.ToArray());
        ...
        {
            string filePath = Path.Combine(EXPORT_ROOT_DIR, exportPackageName);
