...
namespace QFramework
{
    internal static class User
    {
        ...
        {
            get => !string.IsNullOrEmpty(Token.Value) &&
    ...
    public class ReadmeWindow : EditorWindow
    {
        ...
        {
            ReadmeWindow readmeWin = (ReadmeWindow)GetWindow(typeof(ReadmeWindow), true, packageVersion.Name, true);
...
//                            });
    ...
    public class PackageInfosRequestCache
    {
        ...
        private static string mFilePath
        {
            get
            {
                string dirPath = Application.dataPath + "/.qframework/PackageManager/";
        ...
        public static PackageInfosRequestCache Get()
        {
            ...
            {
                string cacheJson = File.ReadAllText(mFilePath);
                ...
                try
                {
                    PackageInfosRequestCache retValue = JsonUtility.FromJson<PackageInfosRequestCache>(cacheJson);
    ...
    public abstract class Window : EditorWindow, IDisposable
    {
        ...
        {
            SubWindow window = GetWindow<SubWindow>(true, name);
            window.Clear();
            return window;
        }
    ...
    public static class EditorUtils
    {
        ...
        {
            get => Selection.activeObject == null ? null : AssetDatabase.GetAssetPath(Selection.activeObject);
        }
        ...
        public static string GetFileMD5Value(string absPath)
        {
            ...
            MD5CryptoServiceProvider md5CSP = new();
            FileStream file = new(absPath, FileMode.Open);
