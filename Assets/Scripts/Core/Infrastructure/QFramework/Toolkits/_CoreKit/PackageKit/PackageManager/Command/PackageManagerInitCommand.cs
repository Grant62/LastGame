...
namespace QFramework
{
    internal class PackageManagerInitCommand : AbstractCommand
    {
        protected override void OnExecute()
        {
            ...
            IPackageManagerServer server = this.GetModel<IPackageManagerServer>();
            ILocalPackageVersionModel installedPackageVersionsModel = this.GetModel<ILocalPackageVersionModel>();
