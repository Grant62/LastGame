...
namespace QFramework
{
    internal class IMDLayoutBuilder : IMDBuilder
    {
        ...
        {
            GUIContent payload = new();
            MDContentImage content = new(payload, mStyle, mLink);
        ...
        public void Prefix(string text, MDStyle style)
        {
            ...
            GUIContent payload = new(text);
            MDContentText content = new(payload, style, null);
        ...
        private void AddWord()
        {
            ...
            GUIContent payload = new(mWord.ToString(), mTooltip);
            MDContentText content = new(payload, mStyle, mLink);
