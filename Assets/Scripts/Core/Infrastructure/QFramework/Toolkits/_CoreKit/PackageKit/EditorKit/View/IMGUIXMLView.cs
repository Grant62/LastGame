...
namespace QFramework
{
    ...
    public class EasyIMGUIXMLModule : IConvertModule
    {
        ...
        public IXMLToObjectConverter GetConverter(string name)
        {
            ...
            foreach (KeyValuePair<string, IXMLToObjectConverter> xmlToObjectConverter in mConverters)
            {
    ...
    internal class XMLView : VerticalLayout, IXMLView
    {
        ...
        private void GenView(IMGUIView parentLayout, XmlNode parentNode)
        {
            ...
            {
                IXMLToObjectConverter converter = mConverter.Value.GetConverter(childNode.Name);

                IMGUIView view = converter.Convert<IMGUIView>(childNode);

                IMGUILayout layout = parentLayout as IMGUILayout;
        ...
        private readonly Lazy<IConvertModule> mConverter = new(() => XMLKit.Get.SystemLayer.Get<IXMLToObjectConvertSystem>()
    ...
    public class XMLKit
    {
        ...
        public static XMLKit Get { get => mInstance.Value; }
