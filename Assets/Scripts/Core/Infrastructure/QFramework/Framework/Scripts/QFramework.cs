...
namespace QFramework
{
    ...
    public class TypeEventSystem
    {
        ...
        {
            EasyEvent<T> e = mEvents.GetEvent<EasyEvent<T>>();
            if (e != null)
            {
    ...
    public class EasyEvents
    {
        ...
        {
            return mTypeEvents.TryGetValue(typeof(T), out IEasyEvent e) ? (T)e : default;
        }

        public T GetOrAddEvent<T>() where T : IEasyEvent, new()
        {
            Type eType = typeof(T);
            if (mTypeEvents.TryGetValue(eType, out IEasyEvent e))
            {
                return (T)e;
            }
