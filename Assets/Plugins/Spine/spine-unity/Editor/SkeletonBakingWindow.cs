...
namespace Spine.Unity.Editor
{
    ...
    public class SkeletonBakingWindow : EditorWindow
    {
        ...
        {
            SkeletonBakingWindow window = GetWindow<SkeletonBakingWindow>(IsUtilityWindow);
        ...
        private void OnGUI()
        {
            ...
            if (hasExtraSkins)
            {
                ...
                if (SpineInspectorUtility.LargeCenteredButton(SpineInspectorUtility.TempContent(string.Format("Bake Skeleton with Skin ({0})", bakeSkin == null ? "default" : bakeSkin.Name),
                        prefabIcon)))
                {
