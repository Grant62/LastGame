...
namespace DG.Tweening
{
    ...
    public static class DOTweenCYInstruction
    {
        ...
        {
            public override bool keepWaiting { get => t.active && !t.IsComplete(); }
        ...
        {
            public override bool keepWaiting { get => t.active && (!t.playedOnce || t.position * (t.CompletedLoops() + 1) > 0); }
        ...
        {
            public override bool keepWaiting { get => t.active; }
        ...
        {
            public override bool keepWaiting { get => t.active && t.CompletedLoops() < elapsedLoops; }
        ...
        {
            public override bool keepWaiting { get => t.active && t.position * (t.CompletedLoops() + 1) < position; }
        ...
        {
            public override bool keepWaiting { get => t.active && !t.playedOnce; }
