...
namespace Cysharp.Threading.Tasks
{
    public static partial class UnityAsyncExtensions
    {
            ...
            CancellationToken cancellationToken = default, bool cancelImmediately = false)
        {
            ...
            return new UniTask<AsyncGPUReadbackRequest>(AsyncGPUReadbackRequestAwaiterConfiguredSource.Create(asyncOperation, timing, cancellationToken, cancelImmediately, out short token),
                token);
        }

        private sealed class AsyncGPUReadbackRequestAwaiterConfiguredSource : IUniTaskSource<AsyncGPUReadbackRequest>, IPlayerLoopItem,
            ITaskPoolNode<AsyncGPUReadbackRequestAwaiterConfiguredSource>
        {
            ...
            public ref AsyncGPUReadbackRequestAwaiterConfiguredSource NextNode { get => ref nextNode; }
            ...
            public static IUniTaskSource<AsyncGPUReadbackRequest> Create(AsyncGPUReadbackRequest asyncOperation, PlayerLoopTiming timing, CancellationToken cancellationToken,
                bool cancelImmediately, out short token)
            {
                ...
                if (cancelImmediately && cancellationToken.CanBeCanceled)
                {
                    ...
                    {
                        AsyncGPUReadbackRequestAwaiterConfiguredSource promise = (AsyncGPUReadbackRequestAwaiterConfiguredSource)state;
