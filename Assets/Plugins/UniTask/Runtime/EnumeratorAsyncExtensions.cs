...
namespace Cysharp.Threading.Tasks
{
    public static class EnumeratorAsyncExtensions
    {
        ...
        public static UniTask ToUniTask(this IEnumerator enumerator, PlayerLoopTiming timing = PlayerLoopTiming.Update, CancellationToken cancellationToken = default)
        {
            Error.ThrowArgumentNullException(enumerator, nameof(enumerator));
        ...
        private sealed class EnumeratorPromise : IUniTaskSource, IPlayerLoopItem, ITaskPoolNode<EnumeratorPromise>
        {
            ...
            public ref EnumeratorPromise NextNode { get => ref nextNode; }
