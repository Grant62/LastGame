...
namespace Cysharp.Threading.Tasks.CompilerServices
{
    ...
    internal static class StateMachineUtility
    {
        ...
        {
            FieldInfo info = stateMachine.GetType().GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance)
        ...
        where TStateMachine : IAsyncStateMachine
    {
        ...
        public ref AsyncUniTaskVoid<TStateMachine> NextNode { get => ref nextNode; }
        ...
        where TStateMachine : IAsyncStateMachine
    {
        ...
        public ref AsyncUniTask<TStateMachine> NextNode { get => ref nextNode; }
        ...
        where TStateMachine : IAsyncStateMachine
    {
        ...
        public ref AsyncUniTask<TStateMachine, T> NextNode { get => ref nextNode; }
