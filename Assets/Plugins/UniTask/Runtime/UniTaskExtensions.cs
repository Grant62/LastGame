...
namespace Cysharp.Threading.Tasks
{
    public static partial class UniTaskExtensions
    {
        ...
        {
            UniTaskCompletionSource<T> promise = new();
        ...
        {
            UniTaskCompletionSource promise = new();
        ...
        public static async UniTask Timeout(this UniTask task, TimeSpan timeout, DelayType delayType = DelayType.DeltaTime, PlayerLoopTiming timeoutCheckTiming = PlayerLoopTiming.Update,
            CancellationTokenSource taskCancellationTokenSource = null)
        {
            CancellationTokenSource delayCancellationTokenSource = new();
