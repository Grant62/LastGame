    ...
    internal static class DiagnosticsExtensions
    {
        ...
        private static string BeautifyType(Type t, bool shortName)
        {
            ...
            if (!t.IsGenericType)
                return shortName
                    ? t.Name
                    : t.FullName.Replace("Cysharp.Threading.Tasks.Triggers.", "").Replace("Cysharp.Threading.Tasks.Internal.", "").Replace("Cysharp.Threading.Tasks.", "") ?? t.Name;
        ...
        private static bool IgnoreLine(MethodBase methodInfo)
        {
            ...
            if (declareType.StartsWith("Cysharp.Threading.Tasks.AwaiterActions"))
            {
                return true;
            }
